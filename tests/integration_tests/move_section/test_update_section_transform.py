...
def model():
    ...
    commands.load_section = LoadImageCommand(_repo=section_repo, _atlas_repo=atlas_repo, _ome_reader=reader,
                                             _tiff_reader=TiffImageReader())
    commands.update_section = UpdateSectionTransformCommand(_section_repo=section_repo, _atlas_repo=atlas_repo)
