...
def launch_gui(create_qapp: bool = True):
    ...
    coronal_section_view = AtlasSectionView(_model=AtlasSectionViewModel(plane='coronal', _model=model))
    axial_section_view = AtlasSectionView(_model=AtlasSectionViewModel(plane='axial', _model=model))
    sagittal_section_view = AtlasSectionView(_model=AtlasSectionViewModel(plane='sagittal', _model=model))
